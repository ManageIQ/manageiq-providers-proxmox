class ManageIQ::Providers::Proxmox::Inventory::Persister::InfraManager < ManageIQ::Providers::Proxmox::Inventory::Persister
  def initialize_inventory_collections
    ...
    add_collection(infra, :host_virtual_switches, :parent_inventory_collections => %i[hosts])
    add_collection(infra, :host_virtual_lans, :parent_inventory_collections => %i[hosts])
    add_collection(infra, :host_switches, :parent_inventory_collections => %i[hosts])
